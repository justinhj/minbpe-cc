...
./zig-out/bin/minbpe-cc --train --input data/shakespeare.txt --special-tokens-path ./data/special1.txt --model-path tests/gpt4-model --vocab-size 512 --encoder gpt4 --conflict-resolution first --verbose
