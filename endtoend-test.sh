...
./zig-out/bin/minbpe-cc --train --input data/taylorswift.txt --model-path tests/basic-model --vocab-size 512 --encoder basic --conflict-resolution lexical
...
./zig-out/bin/minbpe-cc --train --input data/taylorswift.txt --special-tokens-path ./data/special1.txt --model-path tests/gpt4-model --vocab-size 512 --encoder gpt4 --conflict-resolution first --verbose
